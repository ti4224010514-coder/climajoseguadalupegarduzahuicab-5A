...
<body>
    <div class="card">
        ...
        <p><strong>Pronóstico:</strong> <?php echo $data['dataseries'][20]['weather']; ?></p>
        <p><strong>Temperatura:</strong> <?php echo $data['dataseries'][20]['temp2m']; ?>°C</p>
        <p><strong>Viento:</strong> <?php echo $data['dataseries'][20]['wind10m']['direction']; ?> a <?php echo $data['dataseries'][0]['wind10m']['speed']; ?> km/h</p>
        
        <p><strong>Nivel de Nublado:</strong> <?php echo $data['dataseries'][20]['cloudcover']; ?> </p>
        <p><strong>Humedad:</strong> <?php echo $data['dataseries'][20]['rh2m']; ?></p>
        <p><strong>Precipitación:</strong> <?php echo $data['dataseries'][20]['prec_type']; ?></p>
